...
{{{{
    ...
    "action_input": string // The input to the action. May be a stringified object. This is not to be written in character and is purely to express the desired action.
}}}}
\`\`\`
...
{{{{
    "action": "Final Answer",
    "action_input": string // You should put what you want to return to use here and make sure to use valid json newline characters. This must be written as if it was written by the character you are roleplaying and you are not to break character.
}}}}
\`\`\`
